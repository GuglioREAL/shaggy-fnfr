...
return graphics.newSprite(
    images.icons,
	{
		...
		{x = 600, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 25: Shaggy
		{x = 750, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 26: Shaggy Losing
		{x = 900, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 27: God Shaggy
		{x = 1050, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 28: God Shaggy Losing
		{x = 1200, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 29: Red Shaggy
		{x = 1350, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 30: Red Shaggy Losing
		{x = 0, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 31: WB Shaggy
		{x = 150, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 32: WB Shaggy Losing
		{x = 300, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 33: Phantom Shaggy
		{x = 450, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0} -- 34: Phantom Shaggy Losing
	},
	{
		...
		["shaggy"] = {start = 25, stop = 25, speed = 0, offsetX = 0, offsetY = 0},
		["shaggy losing"] = {start = 26, stop = 26, speed = 0, offsetX = 0, offsetY = 0},
		["god shaggy"] = {start = 27, stop = 27, speed = 0, offsetX = 0, offsetY = 0},
		["god shaggy losing"] = {start = 28, stop = 28, speed = 0, offsetX = 0, offsetY = 0},
		["red shaggy"] = {start = 29, stop = 29, speed = 0, offsetX = 0, offsetY = 0},
		["red shaggy losing"] = {start = 30, stop = 30, speed = 0, offsetX = 0, offsetY = 0},
		["WB shaggy"] = {start = 31, stop = 31, speed = 0, offsetX = 0, offsetY = 0},
		["WB shaggy losing"] = {start = 32, stop = 32, speed = 0, offsetX = 0, offsetY = 0},
		["phantom shaggy"] = {start = 33, stop = 33, speed = 0, offsetX = 0, offsetY = 0},
		["phantom shaggy losing"] = {start = 34, stop = 34, speed = 0, offsetX = 0, offsetY = 0}
	},
	"boyfriend",
	false
)
